...
mixin _$ProductsState {
  List<ProductModel> get documents => throw _privateConstructorUsedError;
...
abstract class $ProductsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<ProductModel> documents, Status status, String? errorMessage});
}
...
class _$_ProductsState implements _ProductsState {
  _$_ProductsState(
      {final List<ProductModel> documents = const [],
      this.status = Status.initial,
      this.errorMessage})
      : _documents = documents;

  final List<ProductModel> _documents;
  @override
  @JsonKey()
  List<ProductModel> get documents {
  ...
  @override
  String toString() {
    return 'ProductsState(documents: $documents, status: $status, errorMessage: $errorMessage)';
  }
